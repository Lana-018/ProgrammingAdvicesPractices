...
-- This database contains employee management data, including employee details, salaries, managers, and hierarchical relationships between employees and their managers. 

-- Problem 51: Get all employees that have manager along with Manager's name.
    select Employees.EmployeeID, Employees.Name,
	Employees.ManagerID,Employees.Salary ,Managers.Name as ManagerName 
...
-- incase no manager name the same employee name as manager to himself
    ...
    ManagerName=
	case when Employees.ManagerID is null then Employees.Name
	else Managers.Name 
	end
	from Employees left join Employees as Managers 
	on Employees.ManagerID=Managers.EmployeeID ;
...
-- Problem 54: Get All Employees managed by 'Mohammed'
	...
	Employees.ManagerID,Employees.Salary ,Managers.Name as ManagerName 
	from Employees join Employees as Managers 
	on Employees.ManagerID=Managers.EmployeeID where Managers.Name='Mohammed';
